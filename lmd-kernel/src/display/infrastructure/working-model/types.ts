 ...
 *
 * Pure data shapes for `.lmd` relation documents, Mermaid flowchart graphs,
 * and presentation metadata (sibling `.lths` / legacy `lths-compat`). No React / canvas / UI.
 */
import type { SequenceIR } from '../../../document/domain/sequence';
import type { MindIR } from '../../../document/domain/mind';
